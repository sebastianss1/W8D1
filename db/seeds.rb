...
post1= Post.create!(title: "this is a post", sub_id: sub1.id, author_id: sub1.user_id)
post2= Post.create!(title: "this is another post", sub_id: sub2.id, author_id: sub2.user_id)